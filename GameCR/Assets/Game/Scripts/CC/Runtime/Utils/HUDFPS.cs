...
{
	[AddComponentMenu( "CC/Utilities/HUDFPS")]
	public class HUDFPS : MonoBehaviour
	{
		...
		private int preScreenSize;

		void Start()
		{
			preScreenSize = Screen.height;
			startRect.y = Screen.height - startRect.height - 10;
			StartCoroutine( FPS() );
		}
		...
		void Update()
		{
			...
			if(preScreenSize != Screen.height)
			{
				preScreenSize = Screen.height;
				startRect.y = Screen.height - startRect.height - 10;
			}
