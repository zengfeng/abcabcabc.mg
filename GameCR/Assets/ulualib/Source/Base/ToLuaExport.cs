...
public static class ToLuaExport 
{
    ...
    public static void Generate(params string[] param)
    {
        ...
        if (type.IsEnum)
        {
            ...
            GenEnumTranslator();
            sb.AppendLine("}\r\n");
			SaveFile(Application.dataPath + GameConst.LuaWrapPath + wrapClassName + "Wrap.cs");
            return;
        }
		...
		string path = Application.dataPath + GameConst.LuaWrapPath;
    ...
    {        
        ...
        sb.AppendLine("}");        
		SaveFile(Application.dataPath + GameConst.DelegateFactoryPath);
