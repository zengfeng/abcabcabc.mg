...
namespace SimpleFramework {
    public class Util : MonoBehaviour {
        ...
        public static void ClearMemory() {
            ...
            LuaScriptMgr mgr = Coo.luaManager;
		...
		public static bool DEBUG_MODEL = false;
...
//        }
        ...
        public static string LuaPath() {
			...
			if(Application.isEditor)
			{
				path =Application.dataPath + "/Game/" ;
			}
			else
			{
				path = DataPath;
        ...
        public static string LuaPath(string name) {
            ...
            name = name.Replace('.', '/');
			//Debug.Log("[Util.LuaPath("+name+")] " + path + "Lua/" + name + ".lua");
		...
		/// 取得Lua路径
		/// </summary>
		public static string LuaAssetBundleAssetName(string name) {
			string lowerName = name.ToLower();
			if (lowerName.EndsWith(".lua")) {
				int index = name.LastIndexOf('.');
				name = name.Substring(0, index);
			...
			name = name.Replace('.', '/');
			return GameConst.LuaBytesRoot +  name + GameConst.BytesExt;
		}
        ...
        public static int CheckRuntimeFile() {
			...
			string sourceDir = Application.dataPath + GameConst.LuaWrapPath;
		...
		public static object[] CallTableMethod(string module, string func, params object[] args) {
			LuaScriptMgr luaMgr = Coo.luaManager;
			if (luaMgr == null) return null;
			LuaTable luaTable = luaMgr.GetLuaTable(module);
			LuaFunction luaFunction = luaTable[func] as LuaFunction;
			return luaFunction.Call(luaTable, args);
		}
