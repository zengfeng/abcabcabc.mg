...
public class Packager {
	...
	[MenuItem("Game/Build OSXIntel64 Resource", false, 14)]
	public static void BuildOSXIntel64Resource() {
		BuildAssetResource(BuildTarget.StandaloneOSXIntel64, true);
	}
    /// <summary>
    /// 生成绑定素材
    /// </summary>
    public static void BuildAssetResource(BuildTarget target, bool isWin) {
        ...
        string resPath = AppDataPath + "/" + GameConst.AssetDirname + "/";
    ...
    static void EncodeLuaFile(string srcFile, string outFile, bool isWin) {
        ...
        if (Application.platform == RuntimePlatform.WindowsEditor) {
			...
			exedir = AppDataPath + "/ulualib/Encoder/luajit/";
        } else if (Application.platform == RuntimePlatform.OSXEditor) {
            luaexe = "./luac";
            args = "-o " + outFile + " " + srcFile;
			exedir = AppDataPath + "/ulualib/Encoder/luavm/";
        }
