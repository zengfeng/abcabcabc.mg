...
public static class LuaBinding
{
    ...
    //static LuaBinding()
    //{        
	//    string dir = Application.dataPath + AppConst.LuaWrapPath;
    ...
    static BindType[] binds = new BindType[]
    {
		...
		// Game.Module
		// _GT(typeof(Goo)),
		_GT(typeof(SysmsgManager)),
        _GT(typeof(Prop)),
        _GT(typeof(PrefabText)),

        //Game.Module.War
        _GT (typeof(Formation)),
		_GT (typeof(FormationPosition)),
		_GT (typeof(War)),
		_GT (typeof(WarModel)),
		_GT (typeof(StageConfig)),
		_GT (typeof(StageType)),
		_GT (typeof(WinConfig)),
		_GT (typeof(WinType)),
		_GT (typeof(StagePositionConfig)),
		_GT (typeof(WinConfig)),
		_GT (typeof(WinType)),
		_GT (typeof(LegionType)),
		_GT (typeof(WarService)),
		_GT (typeof(WarEnterData)),
		_GT (typeof(WarEnterLegionData)),
		_GT (typeof(WarEnterSoliderData)),
		_GT (typeof(WarEnterHeroData)),
		_GT (typeof(WarOverData)),
		_GT (typeof(WarOverLegionData)),
		_GT (typeof(VSMode)),
		_GT (typeof(OverType)),
        _GT (typeof(SkillWarConf)),
		_GT (typeof(MonsterConfig)),
		_GT (typeof(ConstConfig)),
		_GT (typeof(ConstConfig.ID)),
		_GT (typeof(PropConfig)),
		_GT (typeof(PropId)),
		_GT (typeof(WarRecordIO)),

		// proto
		_GT (typeof(ProtoBattleVideoInfo)),
		_GT (typeof(ProtoBattleVideoRoleInfo)),
		_GT (typeof(ProtoRoleBaseInfo)),
		_GT (typeof(ProtoLeagueInfo)),
		_GT (typeof(ProtoRoleBattleInfo)),
		...
		_GT (typeof(MenuManager)),
		_GT(typeof(PacketManager)),
		_GT (typeof(SocketManager)),
		_GT(typeof(LuaHelper)),
		_GT(typeof(LuaBehaviour)), 
		_GT(typeof(RectTransform)),
		_GT (typeof(SocketId)),
		_GT (typeof(PlayerPrefsUtil)),
		_GT (typeof(SoundManager)),
		_GT (typeof(NativeCodeManager)),
		_GT (typeof(CityControl)),
		_GT (typeof(ProvinceControl)),
		_GT (typeof(ImageSetMaterial)),
		_GT (typeof(PathUtil)),
        _GT (typeof(MiscLuaUtil)),
        _GT (typeof(CrashReporter)),
		_GT (typeof(MenuLayerType)),
		_GT (typeof(DateTimeUtils)),


		//plugin
		_GT(typeof(DOTween)),
        _GT(typeof(ShortcutExtensions)),
		_GT(typeof(ShortcutExtensions46)),
		_GT(typeof(TweenExtensions)),
        _GT(typeof(TweenSettingsExtensions)),
		_GT(typeof(RotateMode)),
        _GT(typeof(ScrambleMode)),
        _GT(typeof(Ease)),
        _GT(typeof(DOTweenLuaUtils)),

		//CC.UI
		_GT(typeof(BaseUI)),
		_GT(typeof(TabButton)),
		_GT(typeof(TabGroup)),
		_GT(typeof(TabGroup)),
		_GT(typeof(ActiveButton)),
		_GT(typeof(ActiveGroup)),
		_GT(typeof(TableView)),
		_GT(typeof(ScrollZoomContainer)),
		_GT(typeof(ExtendButton)),
		_GT(typeof(MultiImage)),
		_GT(typeof(SliderWithText)),
		
		//unity UGUI
		_GT(typeof(Graphic)).SetBaseName("UnityEngine.Component"),
		_GT(typeof(Text)).SetBaseName("UnityEngine.UI.Graphic"),
		_GT(typeof(InputField)),
		_GT(typeof(Toggle)),
		_GT(typeof(Button)),
		_GT(typeof(UnityEvent)),
		_GT(typeof(UnityEngine.UI.Button.ButtonClickedEvent)).SetBaseName("UnityEngine.Events.UnityEvent"),
		_GT (typeof(Image)).SetBaseName("UnityEngine.UI.Graphic"),
		_GT(typeof(Slider)).SetBaseName("UnityEngine.Component"),
		_GT (typeof(Selectable)),
		_GT (typeof(LuaUIEvent)),
		_GT (typeof(PathUtil)),
		_GT (typeof(Color)),
		...
		_GT(typeof(Animator)).SetBaseName("UnityEngine.Experimental.Director.DirectorPlayer"),
...
lu
    ...
    static void GenLuaBinder()
    {
		...
		string[] files = Directory.GetFiles("Assets" + GameConst.LuaWrapPath, "*.cs", SearchOption.TopDirectoryOnly);
        ...
        string file = Application.dataPath + GameConst.LuaBinderPath;
		Debug.Log(GameConst.LuaBinderPath);
    ...
    public static void ClearLuaBinder()
    {
		...
		ClearFiles(path + GameConst.LuaWrapPath);
		AssetDatabase.Refresh();
    }
